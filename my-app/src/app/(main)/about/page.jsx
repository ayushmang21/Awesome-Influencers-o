...
const About = () => {
  return (
    <div>
      <header className="bg-white dark:bg-gray-100">
            ...
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                {/* <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
                  ...
                  />
                  <button className="w-full px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto lg:mx-4 hover:bg-blue-800 focus:outline-none focus:bg-blue-500">
                    Subscribe
                  </button>
                </div> */}
              </div>
